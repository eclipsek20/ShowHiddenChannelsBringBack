/**
 * @name ShowHiddenChannelsBringBack
 * @author eclipsek20
 * @authorId 278543574059057154
 * @version 1.0.0
 * @description Displays all hidden Channels, which can't be accessed due to Role Restrictions, this won't allow you to read them (impossible). Set to NOT autoupdate to make it still work.
 * @invite Jx3TjNS
 * @donate https://www.paypal.me/eclipsek20
 * @website https://txpint.com
 * @source https://txpint.com/
 * @updateUrlOld https://mwittrien.github.io/BetterDiscordAddons/Plugins/ShowHiddenChannels/ShowHiddenChannels.plugin.js
 */
